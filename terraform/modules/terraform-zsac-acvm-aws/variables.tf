...
variable "instance_type" {
  ...
  validation {
    condition = (
      ...
      var.instance_type == "t3.medium" #This is only recommended for lab/testing purposes and only works with Amazon Linux 2 AMIs. Zscaler AMI does not support t2.micro
    )
